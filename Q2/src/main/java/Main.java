...
public class Main {
    ...
    public static void main(String []args){
        ...
        WatchFSM State = WatchFSM.Normal_Display; // Initial State
        Normal_Inner_States nState = Normal_Inner_States.Time;
        Alarm_Inner_States aState = Alarm_Inner_States.Alarm;
        Update_Inner_States uState = Update_Inner_States.Min;
